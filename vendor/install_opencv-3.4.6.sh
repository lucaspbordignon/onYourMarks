...
#
# I did some modification so that it installs opencv-3.4.6 instead.  Refer to my blog posts for more details. (JK)
#
# This script was modified to better fit the Jetson TX2 environment,
# using Jetpack 3.3 and CUDA 9.0
#
# Authors:
#    - JK Jung, jkjung13@gmail.com
#    - Lucas B., bordi.lucas@gmail.com (minor changes)
...
sudo apt-get install -y python2.7-dev python3-dev python3-testresources
